...
export function department(params) {
  return request
    .get("/mock/department/list", { params })
    .then((res) => res.data);
}
...
export function departmentAdd(params) {
  return request
    .get("/mock/department/add", { params })
    .then((res) => res.data);
}
...
export function departmentEdit(params) {
  return request
    .get("/mock/department/edit", { params })
    .then((res) => res.data);
}
...
export function departmentSwitch(params) {
  return request
    .get("/mock/department/switch", { params })
    .then((res) => res.data);
}
...
export function departmentDel(params) {
  return request
    .get("/mock/department/del", { params })
    .then((res) => res.data);
}
